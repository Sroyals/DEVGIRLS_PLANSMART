...
df = pd.read_csv('modified_vendors_data_1.csv')
        ...
        for index, row in df.iterrows():
            ...
            if not existing_user:
                ...
                new_user = User(
                    ...
                    user_uid=row['email'],
                    password= generate_password_hash('string'),  # Replace with appropriate logic for passwords
                    address=row['address'],
